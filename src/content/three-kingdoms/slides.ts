  ...
  5: [
    {
      ...
      takeaway: "표를 고치기 전에 원본 행 수와 파일 이름을 정제 기록지에 먼저 적습니다.",
      image: "muryeong",
    ...
    },
    {
      ...
      left: {
        ...
        items: ["같은 뜻의 표기만 공통값으로 맞춥니다.", "바꾼 까닭을 정제 기록지에 남깁니다."],
      },
      right: {
        label: "잘못된 정제",
    ...
    },
    {
      ...
      instruction: "정제 기록지 한 줄에는 찾은 문제·처리 방법·수정 이유를 함께 씁니다.",
      steps: ["문제가 있는 셀과 원래 값 찾기", "학급 표준표에 따라 값 고치기", "수정 이유와 확인한 출처 기록하기"],
      image: "gaya",
      source: sources.googleSheets,
    },
    {
