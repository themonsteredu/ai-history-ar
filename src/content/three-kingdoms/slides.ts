...
const lessonExtensions: Partial<Record<number, readonly LessonSlide[]>> = {
  ...
  2: [
    ...
    },
    {
      ...
      points: [
        ...
        "활동지·웹앱·이 화면은 모두 같은 기호와 같은 항목 이름을 씁니다.",
      ],
  ...
  4: [
    ...
    },
    {
      ...
      takeaway: "활동지·웹앱·이 화면의 항목 이름과 순서는 모두 같습니다.",
      image: "cheomseongdae",
      source: sources.cheomseongdae,
    },
    {
    ...
    },
    {
      ...
      instruction: "웹앱에서 모둠만 고르면 바로 시작합니다. 발표를 들은 뒤에 그 모둠의 정답을 공개합니다.",
...
const deckPlans: Record<number, DeckPlan> = {
  ...
  2: {
    ...
    closing: { image: "cheomseongdae", title: "AI가 자신 있게 말하면 모두 사실일까요?", prompt: "아니요. 출처가 없거나 학자들의 의견이 나뉘는 내용을 확정적으로 말할 수 있습니다. 오늘 우리가 한 확인에는 출처·시기·교차·원본·보류라는 이름이 있고, 다음 시간에 그 이름을 붙여 봅니다.", next: "다음 시간 · 오늘 한 확인에 이름 붙이기" },
  },
  3: {
    title: "진짜인지\n확인하는 방법",
    ...
    closing: { image: "crown", title: "끝까지 확인해도 알 수 없다면 어떻게 해야 할까요?", prompt: "모르는 내용을 꾸며내지 않고 ‘아직 모름’으로 보류합니다. 보류는 실패가 아니라 현재 근거의 한계를 정확히 밝히는 역사 공부입니다.", next: "4차시 · 우리 모둠 데이터 만들기" },
  },
  4: {
    title: "우리 모둠\n데이터 만들기",
    ...
    activity: {
      ...
      steps: ["활동지에 일곱 항목 채우기", "웹앱에서 우리 모둠 고르고 그대로 입력하기", "학급 데이터 표에 우리 줄이 올라갔는지 확인하기"],
    },
