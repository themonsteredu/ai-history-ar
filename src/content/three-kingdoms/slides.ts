...
const lessonExtensions: Partial<Record<number, readonly LessonSlide[]>> = {
  ...
  2: [
    ...
    },
    {
      ...
      instruction: "교사가 한 문장씩 보여 주면 학생은 손이나 말로 판단하고, 활동지에는 의심한 이유를 적습니다.",
      steps: ["문장에서 단정 표현 찾기", "자료와 맞음·확인 필요 중 하나 고르기", "그렇게 판단한 이유 한 문장 쓰기"],
      image: "incense",
      source: sources.overview,
    },
    {
  ...
  4: [
    ...
    },
    {
      ...
      instruction: "모둠별 자료실에서 담당 유산을 고르고, 학생 활동지에는 자기 말과 출처 번호로 기록합니다.",
      steps: ["조사할 항목과 읽을 자료 나누기", "확인한 사실을 짧게 바꾸어 쓰고 출처 붙이기", "AI 오류와 아직 모르는 점을 마지막에 함께 점검하기"],
      image: "incense",
      source: sources.incense,
    },
    {
  ...
  5: [
    {
      ...
      instruction: "담당 유산의 사진과 조사 카드를 보며 가장 먼저 보여 주고 싶은 특징을 하나 고르세요.",
      image: "incense",
      source: sources.overview,
    },
    {
      ...
      points: ["유산 이름과 핵심 위치 표시는 한눈에 보여야 합니다.", "사진에 이미 보이는 전체 모습보다 놓치기 쉬운 특징을 강조합니다.", "4차시 조사 카드에서 확인한 사실만 장면에 넣습니다."],
    ...
    },
    {
      ...
      title: "한 문장 해설은 보이는 것과 확인한 사실을 연결합니다",
      points: ["‘무엇이 보이나요?’로 관람객의 시선을 먼저 이끕니다.", "확인한 사실은 쉬운 낱말로 15초 안에 말합니다.", "아직 모르는 내용은 확정된 장면처럼 설명하지 않습니다."],
      takeaway: "예: 금관의 세움 장식과 굽은옥을 찾아보세요. 왕릉급 무덤에서 발견된 권위의 상징입니다.",
      image: "crown",
      source: sources.crown,
    },
    {
    ...
    },
    {
      ...
      instruction: "담당 유산의 카메라 또는 대체 체험을 실행하고, 활동지에 등장 요소·움직임·해설·관람객 행동을 정합니다.",
      steps: ["체험에서 좋았던 점과 고칠 점 한 가지씩 찾기", "조사 카드에서 AR로 보여 줄 확인 사실 하나 고르기", "카드 인식 뒤 이어질 장면과 관람객 행동 스케치하기"],
      image: "muryeong",
      source: sources.muryeong,
    },
    {
      ...
      verdict: "틀림",
      explanation: "검증한 사실 하나가 잘 보이고 관람객이 직접 관찰할 행동이 있을 때 좋은 AR입니다. 확인되지 않은 장면과 불필요한 효과는 줄입니다.",
      image: "gaya",
      source: sources.gaya,
    },
  ],
...
const deckPlans: Record<number, DeckPlan> = {
  ...
  4: {
    ...
    activity: {
      ...
      instruction: "공식 자료와 교사 제공 자료집을 읽고, 확인한 내용은 자기 말로 바꾸어 출처 번호와 함께 씁니다.",
      steps: ["시기·목적·가치·현재 상태 확인하기", "AI 오류를 근거 있는 문장으로 바로잡기", "아직 모르는 점과 출처 기록하기"],
    },
    closing: { image: "gaya", title: "조사 카드의 모든 칸을 꼭 답으로 채워야 할까요?", prompt: "아니요. 신뢰할 수 있는 자료로 확인한 내용만 쓰고, 결론이 나지 않거나 근거가 부족한 내용은 ‘아직 모름’으로 남겨야 합니다.", next: "5차시 · AR로 만나는 문화유산" },
  },
  5: {
    title: "AR로 만나는\n문화유산",
    subtitle: "AR을 체험하고 검증한 역사 사실이 드러나는 한 장면을 기획합니다.",
    coverImage: "crown",
    history: {
      image: "crown",
      title: "신라 금관은 작은 장식 하나에도 관찰할 특징이 있습니다",
      points: ["왕릉급 무덤의 부장품으로 발견되었습니다.", "나뭇가지 모양 장식과 굽은옥이 보입니다.", "실제 착용 방법은 하나의 결론으로 확정하기 어렵습니다."],
      takeaway: "AR은 세움 장식과 굽은옥처럼 사진에서 놓치기 쉬운 특징을 가리키는 데 사용할 수 있습니다.",
      source: sources.crown,
    },
    data: {
      image: "incense",
      title: "AR 기획서는 네 가지 결정을 기록합니다",
      points: ["카드 인식 뒤 무엇이 나타나는지 정합니다.", "어떻게 움직이고 어떤 한 문장을 말할지 정합니다.", "관람객이 직접 할 행동 한 가지를 정합니다."],
      takeaway: "모든 결정은 4차시 조사 카드의 확인된 사실과 연결합니다.",
    },
    compare: {
      image: "cheomseongdae",
    ...
    activity: {
      image: "incense",
      title: "체험하고 우리 AR 한 장면을 기획해요",
      instruction: "담당 유산을 고른 뒤 카메라 또는 대체 체험을 실행하고, 활동지에 네 가지 결정을 기록합니다.",
      steps: ["등장 요소와 움직임 살펴보기", "확인된 사실로 한 문장 해설 만들기", "관람객 행동과 카드 스케치 정하기"],
    },
    closing: { image: "gaya", title: "멋있지만 근거가 없는 장면도 AR에 넣어도 될까요?", prompt: "넣지 않습니다. AR은 상상을 사실처럼 보이게 할 수 있으므로 4차시에서 확인한 내용만 표현하고, 아직 모르는 부분은 질문이나 판단 보류로 남겨야 합니다.", next: "6차시 · 헤리티지 검증 공방" },
  },
  6: {
    title: "역사 데이터를\n그림으로 보기",
