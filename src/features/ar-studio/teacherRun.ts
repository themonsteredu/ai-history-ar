...
export const runLessons: RunLesson[] = [
  ...
  },
  {
    ...
    prepare: ['모둠 책상에 유물 카드 놓기', '지난 시간과 같은 수업코드', '관람용 입장 QR 띄우기', '이어폰'],
    steps: [
      { actor: 'student', minutes: 3, title: '관람 QR 찍고 들어가기', press: '들어가기', detail: '관람용 QR은 관람·퀴즈 두 버튼만 있는 화면을 엽니다.' },
      { actor: 'student', minutes: 5, title: '못 올린 모둠 마무리 공유', press: '모둠에 공유', detail: '지난번 그 태블릿에서 만들기 화면을 열어 누릅니다.' },
      { actor: 'teacher', minutes: 2, title: '모둠이 다 공유됐는지 확인', detail: '아래 현황이 다 초록색이 된 뒤 시작합니다.' },
      { actor: 'student', minutes: 15, title: '카드 비추며 관람', press: 'AR 카메라로 카드 비추기', detail: '아직 공유 안 된 카드는 화면이 이유를 알려 줍니다.' },
      { actor: 'teacher', minutes: 1, title: '자리로 돌려보내고 퀴즈 안내', detail: '공유가 다 끝난 뒤에 시작합니다.' },
      { actor: 'student', minutes: 10, title: '문제 풀고 제출', press: '내 답안과 활동 기록 제출', detail: '모둠별로 나뉘어 나옵니다. 한 번만 낼 수 있습니다.' },
