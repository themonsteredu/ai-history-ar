...
export default function SampleExhibition() {
  ...
  return <main className="studio-page studio-sample page-width">
    ...
    <header className="studio-sample-intro"><p className="eyebrow">준비된 예제로 바로 시작</p><h1>표·그래프 없이 AR부터 체험해요</h1><p>첨성대 모형·해설 3개·문제 2개를 준비했어요. 수업코드나 작품 제출 없이 열어 볼 수 있어요.</p><p>기본 도형으로 만든 학습용 모형입니다. 실제 유물의 세부 모습은 사진과 비교해 주세요.</p></header>
